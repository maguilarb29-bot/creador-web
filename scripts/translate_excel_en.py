...
SHEET_NAMES = {
    ...
    "Valoraci\u00f3n Sotheby's": "Sotheby's Valuation",
}

FULL = {
    "SUCESI\u00d3N PIGNATELLI \u2013 CONDOMINIO SOLARIS": "PIGNATELLI ESTATE \u2013 CONDOMINIO SOLARIS",
    "Reservas de Herederos sobre Inventario Solaris \u2013 Abril 2026": "Heirs' Reservations on Solaris Inventory \u2013 April 2026",
    "Valoraciones: Sotheby's International Realty, Londres, 18 de enero de 2016  (USD)": "Valuations: Sotheby's International Realty, London, January 18, 2016  (USD)",
    "HEREDERO": "HEIR",
    "\u00cdTEMS\nRESERVADOS": "RESERVED\nITEMS",
    "\u00cdTEMS CON\nTASACI\u00d3N": "ITEMS WITH\nVALUATION",
    "ESTIMADO\nM\u00cdNIMO (USD)": "MINIMUM\nESTIMATE (USD)",
    "ESTIMADO\nM\u00c1XIMO (USD)": "MAXIMUM\nESTIMATE (USD)",
    "TOTAL": "TOTAL",
    "DETALLE DE RESERVAS POR HEREDERO \u2013 SUCESI\u00d3N PIGNATELLI": "RESERVATION DETAILS BY HEIR \u2013 PIGNATELLI ESTATE",
    "Valoraci\u00f3n Sotheby's 2016  |  Inventario fotogr\u00e1fico oficial Condominio Solaris": "Sotheby's Valuation 2016  |  Official Photographic Inventory Condominio Solaris",
    "N\u00ba": "No.",
    "C\u00d3DIGO": "CODE",
    ...
    "REF.\nSOTHEBY'S": "SOTHEBY'S\nREF.",
    "ESTIMACI\u00d3N\n(USD)": "ESTIMATE\n(USD)",
    "  10 \u00edtems reservados": "  10 items reserved",
    "  9 \u00edtems reservados": "  9 items reserved",
    "  4 \u00edtems reservados": "  4 items reserved",
    "  2 \u00edtems reservados": "  2 items reserved",
    ...
    "VALORACI\u00d3N SOTHEBY'S \u2013 \u00cdTEMS RESERVADOS": "SOTHEBY'S VALUATION \u2013 RESERVED ITEMS",
    "Sotheby's International Realty \u2013 Londres \u2013 18 de enero de 2016  |  Valores en USD": "Sotheby's International Realty \u2013 London \u2013 January 18, 2016  |  Values in USD",
    "P\u00c1G.": "PAGE",
    "DESCRIPCI\u00d3N DEL OBJETO": "OBJECT DESCRIPTION",
    "ESTIMACI\u00d3N (USD)": "ESTIMATE (USD)",
    "  TOTAL TASADO  \u2013  18 \u00edtems con referencia Sotheby's": "  TOTAL APPRAISED  \u2013  18 items with Sotheby's reference",
    "$ 81,876 \u2013 $ 115,616": "$ 81,876 \u2013 $ 115,616",
    "Ref. (Sin codigo)": "Ref. (No code)",
}

LEGAL_NOTE_ES_FRAGMENT = "reservas consignadas en este documento"
LEGAL_NOTE_EN = (
...
FOOTER_ES_FRAGMENT = "tems reservados sin referencia"
FOOTER_EN = (
...
def translate(val):
    ...
    if LEGAL_NOTE_ES_FRAGMENT in val:
        return LEGAL_NOTE_EN
    if FOOTER_ES_FRAGMENT in val:
        return FOOTER_EN
    return val
